...
if __name__ == "__main__":
    ...
    pretrained_model_name_or_path = "/n/work1/muyun/Model/hf_model/hub/models--Qwen--Qwen3-0.6B/snapshots/c1899de289a04d12100db370d81485cdf75e47ca"
    ...
    for i in range(len(t["input_ids"])):
        print(tokenizer.decode(t["input_ids"][i]))
